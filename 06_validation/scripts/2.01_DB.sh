...
#SBATCH --output=/gpfs/projects/bsc83/Projects/ribosomal_RNAs/Alba/08_validation/out/02_DB_out/02.create_db.%A.out
#SBATCH --error=/gpfs/projects/bsc83/Projects/ribosomal_RNAs/Alba/08_validation/err/02_DB_err/02.create_db.%A.err
...
outpath=/gpfs/projects/bsc83/Projects/ribosomal_RNAs/Alba/03_VCsimulated/v2/VC_out/hs1-rDNA_${version}/simulated_WGS/${seq_type}/${gatk}/Joingen/
